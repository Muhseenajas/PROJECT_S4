...
class Application(models.Model):
    ...
    technical_time = models.TimeField(
        null=True,
        blank=True
    )

    technical_interviewer = models.CharField(
        max_length=100,
        blank=True
    )
    ...
    technical_attended = models.BooleanField(
        null=True,
        blank=True
    )
    ...
    hr_attended = models.BooleanField(
        null=True,
        blank=True
    )
    ...
    hr_decision_notes = models.TextField(
        blank=True
    )
    ...
    def compute_final_score(self):
        ...
        if (
            self.resume_score is not None and
    ...
    def get_missing_skills_list(self):
        ...
        if self.missing_skills:
            ...
            return [
                skill.strip()
                for skill in self.missing_skills.split(',')
            ]
